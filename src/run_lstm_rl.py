...
from generators_lstm import Generator
from utils import load_config, save_config, set_logger, set_seed
from trainer_lstm import TrainerPredictor, TrainerGenerator
...
def main(args):
    ...
    # =========================================
    # Step 1: Pre-train Generator (LSTM)
    # =========================================
    if comm.get_rank() == 0:
        logging.info('=' * 60)
        logging.info('| RL-GUIDED RULE GENERATION')
        logging.info('=' * 60)
        logging.info('| Step 1: Pre-train Generator (LSTM)')
        logging.info('=' * 60)
